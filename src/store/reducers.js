...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.API_V1_ABCD_LIST:
    case types.API_V1_ABCD_LIST_SUCCEEDED:
    case types.API_V1_ABCD_LIST_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_ABCD_CREATE:
    case types.API_V1_ABCD_CREATE_SUCCEEDED:
    case types.API_V1_ABCD_CREATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_ABCD_READ:
    case types.API_V1_ABCD_READ_SUCCEEDED:
    case types.API_V1_ABCD_READ_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_ABCD_UPDATE:
    case types.API_V1_ABCD_UPDATE_SUCCEEDED:
    case types.API_V1_ABCD_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_ABCD_PARTIAL_UPDATE:
    case types.API_V1_ABCD_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_ABCD_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_ABCD_DELETE:
    case types.API_V1_ABCD_DELETE_SUCCEEDED:
    case types.API_V1_ABCD_DELETE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
