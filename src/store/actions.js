...
export const api_v1_abcd_list = () => ({ type: types.API_V1_ABCD_LIST })
export const api_v1_abcd_listSucceeded = (response, starter) => ({
  type: types.API_V1_ABCD_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_abcd_listFailed = (error, starter) => ({
  type: types.API_V1_ABCD_LIST_FAILED,
  error,
  starter
})
export const api_v1_abcd_create = data => ({
  type: types.API_V1_ABCD_CREATE,
  data
})
export const api_v1_abcd_createSucceeded = (response, starter) => ({
  type: types.API_V1_ABCD_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_abcd_createFailed = (error, starter) => ({
  type: types.API_V1_ABCD_CREATE_FAILED,
  error,
  starter
})
export const api_v1_abcd_read = () => ({ type: types.API_V1_ABCD_READ })
export const api_v1_abcd_readSucceeded = (response, starter) => ({
  type: types.API_V1_ABCD_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_abcd_readFailed = (error, starter) => ({
  type: types.API_V1_ABCD_READ_FAILED,
  error,
  starter
})
export const api_v1_abcd_update = data => ({
  type: types.API_V1_ABCD_UPDATE,
  data
})
export const api_v1_abcd_updateSucceeded = (response, starter) => ({
  type: types.API_V1_ABCD_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_abcd_updateFailed = (error, starter) => ({
  type: types.API_V1_ABCD_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_abcd_partial_update = data => ({
  type: types.API_V1_ABCD_PARTIAL_UPDATE,
  data
})
export const api_v1_abcd_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_ABCD_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_abcd_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_ABCD_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_abcd_delete = () => ({ type: types.API_V1_ABCD_DELETE })
export const api_v1_abcd_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_ABCD_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_abcd_deleteFailed = (error, starter) => ({
  type: types.API_V1_ABCD_DELETE_FAILED,
  error,
  starter
})
